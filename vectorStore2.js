...
const loader = new PDFLoader("./assets/PDF/sample.pdf");
...
const embeddings = new OpenAIEmbeddings({
    ...
    apiKey: `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`, // کلید API خود را اینجا قرار دهید,
    temperature: 0,
    maxTokens: undefined,
    timeout: undefined,
    maxRetries: 2,
